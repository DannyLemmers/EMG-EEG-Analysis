classdef DockingStationInfo < TMSiSAGA.HiddenHandle
    ...
    methods
        function obj = DockingStationInfo(obj)
            %DOCKINGSTATIONINFO - Constructor for the DockingStationInfo object.
            %
            %   obj = DockingStationInfo(obj)
            %
            %   This constructor creates a simple empty DockingStationInfo object.
            %
            %   obj [out/in] - DockingStationInfo object.
            %
        end
    end
